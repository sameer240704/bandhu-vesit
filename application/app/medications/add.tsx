    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          >
            <Ionicons name="chevron-back" size={28} color="#A85DCF" />
          </TouchableOpacity>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.dateIconContainer}>
                <Ionicons name="calendar" size={20} color="#A85DCF" />
              </View>
              ...
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="notifications" size={20} color="#8700A4" />
                  </View>
                  <View>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#ddd", true: "#8700A4" }}
                  thumbColor="white"
                />
              </View>
            </View>
        ...
        <View style={styles.footer}>
          ...
          >
            <LinearGradient
              colors={["#8700A4", "#A85DCF"]}
              style={styles.saveButtonGradient}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
            >
              <Text style={styles.saveButtonText}>
                {isSubmitting ? "Adding..." : "Add task to be done"}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
          <TouchableOpacity
